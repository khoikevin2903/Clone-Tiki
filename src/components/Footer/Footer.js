    ...
    return (
        <div className="container pt-40 pb-10 flex">
            ...
            <div className="w-5/12 flex">
                <input type="text" className="rounded-lg pl-6 mt-20 py-4 w-2/3 border border-blue-300 text-2xl font-normal" placeholder="Địa chỉ email của bạn" />
                <button className="ml-4 rounded-lg px-8 mt-20 py-4 border border-blue-300 bg-blue-500 text-white text-2xl font-normal">Đăng ký</button>
            </div>
        </div>
    );
}
